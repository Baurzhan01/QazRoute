...
export default function SchedulePage() {
  ...
  const getDayTypeInfo = () => {
    switch (dayType) {
      case "workdays":
        return {
          title: "Итоговый план выпуска (Будни)",
          color: "text-sky-700",
        }
      case "saturday":
        return {
          title: "Итоговый план выпуска (Суббота)",
          color: "text-amber-600",
        }
      case "sunday":
        return {
          title: "Итоговый план выпуска (Воскресенье)",
          color: "text-green-600",
        }
      default:
        return {
          title: "Итоговый план выпуска",
          color: "text-sky-700",
        }
    }
  }
  ...
  return (
    <div className="flex flex-col gap-4 p-4 md:p-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          <h1 className={`text-2xl md:text-3xl font-bold tracking-tight ${dayTypeInfo.color}`}>{dayTypeInfo.title}</h1>
